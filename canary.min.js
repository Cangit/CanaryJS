 ...
 * v0.2.0
 */
var CanaryJS=Backbone.Model.extend({defaults:{name:"CanaryJS",level:0,console:!1,numberOfEntries:0},initialize:function(){this.set("debugCollection",new CanaryDebugCollection)},addEntry:function(a,b,c,e){this.get("level")<=e&&("undefined"==b?(this.get("debugCollection").add([{id:this.get("numberOfEntries"),type:c,msg:a}]),b=""):(console.log("stuff"),this.get("debugCollection").add([{id:this.get("numberOfEntries"),type:c,msg:a,obj:b}])),!0==this.get("console")&&this.get("debugCollection").writeToConsole({id:this.get("numberOfEntries"),
